    ...
    <AuthGate>
      <div className="max-w-3xl mx-auto p-3 sm:p-4 space-y-5 sm:space-y-6">
        <div className="relative overflow-hidden rounded-[28px] border chalkboard text-white p-4 sm:p-7 shadow-xl ring-1 ring-white/10">
          <div className="absolute -top-16 -right-12 h-40 w-40 rounded-full bg-rose-400/20 blur-3xl" />
          <div className="absolute -bottom-24 -left-8 h-52 w-52 rounded-full bg-amber-300/10 blur-3xl" />
          <div className="relative z-10">
            <div className="text-[10px] uppercase tracking-[0.28em] text-white/80">Diagnostic</div>
            <h2 className="mt-2 text-xl sm:text-2xl font-semibold">簡易診断（10問）</h2>
            <p className="text-[10px] sm:text-sm text-white/85 mt-2">
              いまの理解度をざっくり確認して、目標コース（55/65/80）と最初の学習順を提案します。
            </p>
          </div>
        </div>
