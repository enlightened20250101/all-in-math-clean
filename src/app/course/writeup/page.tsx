// src/app/course/writeup/page.tsx
import Link from "next/link";
import WriteupClient from "./WriteupClient";

export default function CourseWriteupPage() {
  return (
    <div className="space-y-8 sm:space-y-10">
      <div className="relative overflow-hidden rounded-[28px] border chalkboard text-white p-4 sm:p-8 shadow-xl ring-1 ring-white/10">
        ...
        <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <div className="text-[10px] uppercase tracking-[0.28em] text-white/80">Writeup Hub</div>
            <div className="mt-2 text-xl sm:text-2xl font-semibold tracking-tight">記述演習</div>
            <div className="mt-1 text-sm text-white/85">
              紙で解いた内容を、清書としてまとめるページです。
            </div>
          </div>
