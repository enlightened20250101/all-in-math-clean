// src/lib/course/templates/mathC/conic_circle_general_radius_basic3.ts
...
export const conicCircleGeneralRadiusExtraTemplates2: QuestionTemplate[] = Array.from({ length: 6 }, (_, i) =>
  buildTemplate(`conic_circle_general_radius_basic3_${i + 1}`, `半径 ${i + 1}`)
);
