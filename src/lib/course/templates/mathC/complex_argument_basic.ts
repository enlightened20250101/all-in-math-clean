...
const CASES: ArgCase[] = [
  { a: 1, b: 0, arg: "0^\\circ", explain: "正の実軸上なので偏角は0°" },
  { a: 0, b: 1, arg: "90^\\circ", explain: "正の虚軸上なので偏角は90°" },
  { a: -1, b: 0, arg: "180^\\circ", explain: "負の実軸上なので偏角は180°" },
  { a: 0, b: -1, arg: "270^\\circ", explain: "負の虚軸上なので偏角は270°" },
  { a: 2, b: 0, arg: "0^\\circ", explain: "正の実軸上なので偏角は0°" },
  { a: 0, b: 2, arg: "90^\\circ", explain: "正の虚軸上なので偏角は90°" },
  { a: -2, b: 0, arg: "180^\\circ", explain: "負の実軸上なので偏角は180°" },
  { a: 0, b: -2, arg: "270^\\circ", explain: "負の虚軸上なので偏角は270°" },
];
...
export const complexArgumentTemplates: QuestionTemplate[] = Array.from(
  { length: 20 },
  (_, i) => buildTemplate(`complex_argument_basic_${i + 1}`, `偏角 ${i + 1}`)
);

const extraComplexArgumentTemplates: QuestionTemplate[] = Array.from(
  { length: 30 },
  (_, i) => buildTemplate(`complex_argument_basic_${i + 21}`, `偏角 追加${i + 1}`)
);
