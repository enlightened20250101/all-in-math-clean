// src/lib/course/templates/math2/calculus_integral_sum_backsolve_basic.ts
...
export const calcIntegralSumBacksolveTemplates: QuestionTemplate[] = Array.from({ length: 30 }, (_, i) => {
  const templateId = `calc_integral_sum_backsolve_${i + 1}`;
  return {
    meta: {
      id: templateId,
