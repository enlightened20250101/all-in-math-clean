// src/lib/course/templates/mathB/sequence_geometric_sum_n_backsolve_basic.ts
...
export const sequenceGeometricSumNBacksolveTemplates: QuestionTemplate[] = Array.from({ length: 30 }, (_, i) => {
  const templateId = `seq_geometric_sum_n_backsolve_${i + 1}`;
  return {
    meta: {
      id: templateId,
