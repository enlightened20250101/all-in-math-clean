...
const CASES: Case[] = [
  ...
  {
    id: "int_div_count_app_1",
    title: "約数の個数 72（応用）",
    kind: "divisor_count",
    nums: [72],
    context: "72枚のシールを等分できる方法の数を考える。",
  },
  {
    id: "int_div_count_app_2",
    title: "約数の個数 90（応用）",
    kind: "divisor_count",
    nums: [90],
    context: "90人を同じ人数の班に分けるときの班の人数の候補を数える。",
  },
  {
    id: "int_div_count_app_3",
    title: "約数の個数 120（応用）",
    kind: "divisor_count",
    nums: [120],
    context: "120個の部品を同じ個数ずつ袋詰めできる袋数を数える。",
  },
  {
    id: "int_div_count_app_4",
    title: "約数の個数 144（応用）",
    kind: "divisor_count",
    nums: [144],
    context: "144ページを同じページ数のセットに分ける方法の数を求める。",
  },
  ...
  },
  {
    ...
    kind: "max_multiple",
    nums: [13, 120],
    context: "120以内で13の倍数となる最大の数を求める。",
  },
  {
    id: "int_max_mul_6",
    title: "最大の倍数 15",
    kind: "max_multiple",
    nums: [15, 200],
    context: "200以内で15の倍数となる最大の数を求める。",
  },
  {
    id: "int_max_mul_7",
    title: "最大の倍数 18",
    kind: "max_multiple",
    nums: [18, 170],
    context: "170以下で18の倍数となる最大の数を求める。",
  },
  ...
  },
  {
    ...
    kind: "min_multiple_at_least",
    nums: [11, 140],
    context: "140以上で11の倍数となる最小の数を求める。",
  },
  {
    id: "int_min_mul_6",
    title: "最小の倍数 14",
    kind: "min_multiple_at_least",
    nums: [14, 155],
    context: "155以上で14の倍数となる最小の数を求める。",
  },
];
